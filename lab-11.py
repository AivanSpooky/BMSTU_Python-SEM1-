...
#ls_rand = create_list(n1, "random")
#print()
#ls_sort = create_list(n1, "sorted")
#print()
#ls_revr = create_list("reverse-sorted", "Список, отсортированный в обр. порядке:")
#print()

#print(f"-"*83)

#time, inserts = insertionsort(ls_rand)
#print(f"|{'Упорядоченный':<15}|{time:<10.5f}|{inserts:<10}|"*)
