...
def freq_occur_word(ls):  #ls - список предложений
    print()
    for i, s in enumerate(ls):
        ...
        for n in list(words_count.keys()):
            if words_count[n] == max_count and n != "":
...
# Cам текст
text = ["Во Франции круассаны появились в 1770 году,", "когда когда туда из Вены переехала Мария-Аунтуанетта. Во второй", "половине 19-го века круассан уже упоминается как непременная",
...
while True:
    ...
    print(f"7 - Вывести наиболее часто встречающееся слово в каждом предложении.")
